const Palvelut: IPalvelut[] = [
  {
    title: 'Muutot',
    text: 'Meiltä löytyy muuttoapu jokaiseen kotimuuttoon, olipa kyse yksiön tai omakotitalon muutosta. Yhdessä löydämme sinulle sopivan ratkaisun',
    icon: null,
  },
  {
    title: 'Kantoapu',
    text: 'Onko sinulla muuttoauto varattuna, mutta puuttuu kantajat? Ei hätääme tarjoamme kantoapua jokaiseen tilanteeseen.',
    icon: null,
  },
  {
  ...
  },
  {
    ...
    text: 'Oli sitten kyseessä pieni kantoapu keikka tai iso työmaa urakka, me tarjoamme luotettavan apumiehen teille. Ota yhteyttä ja kysy tarjous.',
    icon: null,
  },
];
